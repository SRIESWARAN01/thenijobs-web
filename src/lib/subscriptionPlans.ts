...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    features: [
      ...
      { label: 'Product Catalogue (3)', included: true, limit: '3 products' },
      { label: 'Service Showcase (3)', included: true, limit: '3 services' },
      { label: 'Digital Business Card', included: true },
      { label: '5 Customer Reviews', included: true, limit: '5 reviews' },
