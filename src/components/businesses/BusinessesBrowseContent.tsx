...
interface BusinessesBrowseContentProps {
  /** True when rendered inside a dashboard shell (seeker/employer) that already has its own
   * header — swaps the sticky offset accordingly instead of leaving a dead 64px gap. */
  embedded?: boolean;
}

/* ─── Content (embeddable in any shell) ─── */
export default function BusinessesBrowseContent({ embedded = false }: BusinessesBrowseContentProps = {}) {
