  ...
  if (!companyId && !companyLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center font-outfit text-white">
        ...
        <p className="text-sm text-gray-400 mt-2 max-w-sm">Please register your profile first to adjust settings.</p>
  ...
  return (
    <div className="space-y-6 animate-fade-in-up font-outfit text-white">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">Configure your service portal settings and preferences</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="max-w-xl space-y-6">
          ...
          <div className="glass-card rounded-2xl p-6 space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">Choose when and how you want to be notified about service updates.</p>
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-9 h-5 rounded-full relative transition-all ${checked ? 'bg-rose-500' : 'bg-white/20'}`}>
          ...
          <div className="glass-card rounded-2xl p-6 space-y-4">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="px-2.5 py-1 rounded-full bg-rose-500/10 text-rose-400 font-bold border border-rose-500/20 flex items-center gap-1 text-[10px]">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-rose-600 to-pink-600 text-white text-xs font-semibold hover:opacity-90 transition-opacity flex items-center justify-center gap-2 disabled:opacity-50"
          >
