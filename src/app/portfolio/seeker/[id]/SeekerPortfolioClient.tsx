          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 -mt-6 space-y-5">
            ...
            <div className="bg-amber-50/60 border border-amber-200 rounded-3xl p-5 shadow-sm space-y-3">
              ...
              <textarea
                ...
                className="w-full p-3 bg-white border border-amber-200 rounded-2xl text-xs text-gray-900 placeholder-amber-700/50 focus:outline-none focus:border-amber-400 resize-none"
                rows={2}
              />
            </div>
