                        ...
                        {replyReviewId === review.id && (
                          <div className="pt-2 space-y-2">
                            <textarea
                              ...
                              className="w-full bg-[#111124] border border-white/10 rounded-lg p-2 text-xs text-white placeholder:text-gray-500 focus:border-rose-500/40 focus:outline-none resize-none"
                            />
