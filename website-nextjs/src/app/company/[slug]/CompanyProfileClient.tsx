          ...
          <div className="flex-1 pb-2">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-1.5">
                {company.name}
                <BadgeCheck size={18} className={`${currentTheme.accent} fill-white/10 shrink-0`} aria-label="Standard Verified Business" role="img" />
              </h1>
            </div>
          ...
          <div className="flex-1 pb-2">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-2xl sm:text-3xl font-black text-white flex items-center gap-2 tracking-tight">
                {company.name}
                <BadgeCheck size={24} className={`${currentTheme.accent} shrink-0 animate-pulse`} aria-label="Premium Gold Tick Business" role="img" />
              </h1>
            </div>
