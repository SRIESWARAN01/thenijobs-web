  ...
  return (
    <div className="space-y-6 animate-fade-in-up font-outfit text-white">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">Configure your business portal settings and preferences</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="max-w-xl space-y-6">
          ...
          <div className="glass-card rounded-2xl p-6 space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">Choose when and how you want to be notified about business updates.</p>
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-9 h-5 rounded-full relative transition-all ${checked ? 'bg-emerald-500' : 'bg-white/20'}`}>
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-xs font-semibold hover:opacity-90 transition-opacity flex items-center justify-center gap-2 disabled:opacity-50"
          >
