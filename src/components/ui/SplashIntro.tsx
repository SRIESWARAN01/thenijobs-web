  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#0a0a1a]">
      ...
      <div className="relative flex flex-col items-center gap-5">
        <div className="thenijobs-logo-reveal flex items-center gap-3 rounded-3xl border border-white/10 bg-white p-5 shadow-2xl">
          <Image src="/logo.png" alt="THENIJOBS" width={48} height={48} priority className="h-12 w-12 object-contain rounded-xl" />
          <span className="font-outfit font-black text-2xl tracking-wider text-slate-900">THENIJOBS</span>
        </div>
